      ...
      <section className={styles.hero}>
        <div>
          ...
          <p className={styles.heroLead}>
            Følg de analyser der synkroniseres automatisk fra OneDrive, se hvor
            mange der er læst ind, og få hurtigt overblik over hvilke rækker der
            stadig kræver et manuelt tjek.
          </p>
